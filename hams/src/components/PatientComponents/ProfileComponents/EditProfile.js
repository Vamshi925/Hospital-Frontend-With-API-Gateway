    ...
    if (patientId && token) {
      try {
        const response = await axios.put(
          `${API_BASE_URL}/login-service/api/patients/update/${patientId}`,
          {
            ...patientInfo,
          ...
          <form onSubmit={handleSubmit} className="edit-profile-form">
            ...
            <div className="form-group">
              ...
              <input
                ...
                id="contactDetails"
                name="contactDetails"
                value={patientInfo.contactDetails}
                onChange={handleChange}
              />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <select id="gender" name="gender" value={patientInfo.gender} onChange={handleChange}>
