    ...
    if (appointmentToCancel) {
      try {
        const response = await axios.post(
          `${API_BASE_URL}/login-service/api/patients/cancelAppointment/${appointmentToCancel}`,
          {},
          {
            headers: {
    ...
    <div>
      ...
      <div className="your-appointments-container">
        ...
        {!loading && !error && filteredAppointments.length === 0 && (
          <p>No appointments found within the selected date range.</p>
        )}
        {!loading && !error && filteredAppointments.length > 0 && (
            ...
            {filteredAppointments.map((appointment) => (
              <div key={appointment.appointmentId} className="appointment-item">
                ...
                <div className="appointment-actions">
                  ...
                  <button
                    onClick={() =>
                      handleReschedule(appointment.appointmentId, appointment.doctorId)
                    }
