...
const YourAppointments = () => {
    ...
    const fetchAppointments = async (patientId, token) => {
        ...
        if (patientId && token) {
            try {
                const response = await axios.get(`${API_BASE_URL}/login-service/api/patients/current/patient/${patientId}`, {
                    headers: {
    ...
    const handleCancelConfirm = async () => {
        if (appointmentToCancel) {
            try {
                const response = await axios.post(`${API_BASE_URL}/login-service/api/patients/cancelAppointment/${appointmentToCancel}`, {}, {
                    headers: {
