...
function Schedule() {
    ...
    const fetchSchedule = async () => {
        try {
            ...
            const response = await axios.get(`${API_BASE_URL}/doctor-service/api/doctorAvailability/getSchedule/${doctorId}`, {
    ...
    const fetchAppointments = async () => {
        try {
            const token = localStorage.getItem('jwtToken');
            const response = await axios.get(`${API_BASE_URL}/doctor-service/api/doctors/current/appointments/${doctorId}`, {
                headers: {
    ...
    const handleToggleAvailability = async (availabilityId, date, session) => {
        try {
            const token = localStorage.getItem('jwtToken');
            await axios.put(`${API_BASE_URL}/doctor-service/api/doctorAvailability/toggle/${availabilityId}`, {}, {
                headers: { Authorization: `Bearer ${token}` },
            });
            fetchSchedule();
    ...
    const handleFilter = async () => {
        try {
            const token = localStorage.getItem('jwtToken');
            const response = await axios.get(`${API_BASE_URL}/doctor-service/api/doctorAvailability/filterSchedule/${startDate}/${endDate}/${doctorId}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
