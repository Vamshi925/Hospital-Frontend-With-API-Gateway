        ...
        <main className="main-content">
          <Routes>
                ...
                <Route
                  ...
                  element={
                    <PatientDashboard
                      ...
                      setErrorPatient={setErrorPatient}
                    />
                  }
                />
                <Route
                  path="/medical-history"
                  element={<PatientMedicalHistory setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="/appointments"
                  element={<YourAppointments setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="/bookappointment"
                  element={<DynamicDoctorAppointment setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="/appointment-confirmation"
                  element={<AppointmentConfirmation setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="/appointment-cancel-confirmation"
                  element={<AppointmentCancelledConfirmation setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="/appointment-reschedule-confirmation"
                  element={<AppointmentRescheduledConfirmation setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="/pastappointments"
                  element={<PastAppointments setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="rescheduleappointment/:appointmentId/:doctorId"
                  element={<RescheduleAppointment setLoggedIn={setIsLoggedIn} />}
                />
            ...
            {isLoggedIn && userRole === 'ROLE_DOCTOR' && (
              <>
                <Route
                  path="/doctor-dashboard/:userId"
                  element={<DoctorDashboard setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="/doctor/:doctorId/appointments"
                  element={<DoctorAppointmentsTable setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="/doctor/:doctorId/past-appointments"
                  element={<DoctorPastAppointments setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="/doctor/:doctorId/schedule"
                  element={<Schedule setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="/doctor/:doctorId/prescriptions"
                  element={<DoctorMedicalHistory setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="/doctor/:doctorId/medical-history"
                  element={<DoctorMedicalHistory setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="/doctor/:doctorId/medical-history/patient/:patientId"
                  element={<DoctorMedicalHistory setLoggedIn={setIsLoggedIn} />}
                />
                <Route
                  path="/appointment-cancel-confirmation"
